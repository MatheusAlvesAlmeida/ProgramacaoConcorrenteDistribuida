...
public class StreamsExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KStream<String,String> counts = records.map((k, v) -> new KeyValue<String, String>(k, v.getDatetime()));
        counts.print(Printed.<String,String>toSysOut().withLabel("Consumed record"));

        // Aggregate values by key
        KStream<String,String> countAgg = counts.groupByKey(Grouped.with(Serdes.String(), Serdes.String()))
            .reduce(
                (aggValue, newValue) -> aggValue + newValue)
            .toStream();
        countAgg.print(Printed.<String,String>toSysOut().withLabel("Running count"));
